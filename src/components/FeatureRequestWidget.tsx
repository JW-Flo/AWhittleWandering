...
const FeatureRequestWidget = forwardRef<HTMLDivElement, FeatureRequestWidgetProps>(
  ({ variant = 'floating', className = '' }, ref) => {
...
FeatureRequestWidget.displayName = 'FeatureRequestWidget';
