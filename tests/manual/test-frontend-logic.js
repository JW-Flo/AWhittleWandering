...
console.log(
  "Parse location test:",
  parseLocation("Watch Hill Point (coastal visit), Rhode Island")
);
console.log(
  "Parse location test 2:",
  parseLocation("Bar Harbor, Cadillac Mountain (sunrise hike), Maine")
);
console.log(
  "Parse location test 3:",
  parseLocation("Stratford stay with Deanna, Connecticut")
);
