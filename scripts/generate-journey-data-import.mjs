...
class JourneyDataImporter {
  static VEHICLE_ID = "5YJYGDEE5LF027324";
  ...
  generateSQLInserts() {
    ...
    this.insertCommands.push(`
      ...
      VALUES (
        '${this.journeyId}',
        '${JourneyDataImporter.VEHICLE_ID}',
  ...
  async generateDriveInserts(timelineData, telemetryData) {
    ...
    for (let i = 0; i < timelineData.length - 1; i++) {
      ...
      const drive = {
        ...
        average_speed: Math.round(distance / duration),
    ...
    drives.forEach((drive) => {
      this.insertCommands.push(`
        INSERT INTO drives (
          ...
          '${JourneyDataImporter.VEHICLE_ID}', '${drive.journey_id}', '${drive.started_at}', '${drive.ended_at}',
          ...
          ${drive.average_speed}, datetime('now')
        );
      `);
    });
      ...
      if (drive.distance_miles > 200 || drive.end_battery_level < 50) {
        ...
        this.insertCommands.push(`
          INSERT INTO charges (
            ...
            '${JourneyDataImporter.VEHICLE_ID}', '${charge.journey_id}', '${charge.started_at}', '${charge.ended_at}',
