...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_MAPBOX_TOKEN': JSON.stringify(env.VITE_MAPBOX_TOKEN || 'pk.eyJ1IjoiaGFyZHdvcmtjbyIsImEiOiJjbWJteHA0cjYwYXRjMm1weGgwdnk5YWw2In0.0Bj4LWRpeefn0qPj_2VHcA'),
      'import.meta.env.VITE_EDGE_WORKER_URL': JSON.stringify(env.VITE_EDGE_WORKER_URL || 'https://awhittlewandering-edge.kd8jc7v8cd.workers.dev'),
      'import.meta.env.VITE_USE_SIMULATED_DATA': JSON.stringify(env.VITE_USE_SIMULATED_DATA || 'false'),
    },
  build: {
    target: "esnext",
    modulePreload: {
