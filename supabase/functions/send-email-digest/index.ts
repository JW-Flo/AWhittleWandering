...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // AUTHENTICATION REQUIRED - Only admin or service role
    ...
    if (!isServiceCall) {
      ...
      console.log("Email digest authorized for admin user:", user.id);
    } else {
      console.log("Email digest authorized via service role key");
    }
