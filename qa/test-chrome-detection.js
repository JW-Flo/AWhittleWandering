...
async function testChromeDetection() {
  ...
  try {
    ...
    await page.goto(
      "data:text/html,<h1>Puppeteer Test Success!</h1><p>Chrome/Chromium is working correctly.</p>"
    );
    ...
    console.log(
      `🔧 Chrome API Available: ${jsResult.chrome ? "✅ Yes" : "❌ No"}`
    );
    ...
    console.error(
      "  • Check if any security software is blocking browser launch"
    );
