...
if (!mapboxgl.accessToken) {
  throw new Error(
    "Mapbox access token is missing. Please set REACT_APP_MAPBOX_TOKEN in your environment."
  );
}
export default function TripMapPage() {
    ...
    if (routeHistory && routeHistory.length > 0) {
      ...
      if (map.current.getSource("route")) {
        ...
        map.current.getSource("route").setData({
          ...
          geometry: {
            type: "LineString",
            coordinates: routeHistory.map((point) => [
              point.longitude,
              point.latitude,
            ]),
          },
        ...
        // Add the route line layer if it doesn't already exist
  ...
  return _jsxs("div", {
    className: "trip-map-page",
    children: [
      _jsxs("div", {
        className: "map-header",
        children: [
          _jsx("h1", { children: "Live Trip Map" }),
          _jsx("p", {
            children:
              "Follow our journey in real-time as we travel across the United States",
          }),
          error &&
            _jsx("div", {
              className: "error-message",
              children: "Unable to load map data. Please try again later.",
            }),
          currentLocation &&
            _jsxs("div", {
              className: "current-location-info",
              children: [
                _jsx("h2", { children: "Current Location" }),
                _jsxs("p", {
                  children: [
                    _jsx("strong", { children: "State:" }),
                    " ",
        ...
        children:
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("p", { children: "Loading map data..." }),
            ],
          }),
      }),
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("div", { className: "legend-color route-color" }),
              _jsx("span", { children: "Route traveled" }),
            ],
          }),
          _jsxs("div", {
            className: "legend-item",
            children: [
              _jsx("div", { className: "legend-icon vehicle-icon" }),
              _jsx("span", { children: "Current location" }),
            ],
          }),
          _jsxs("div", {
            className: "legend-item",
            children: [
              _jsx("div", { className: "legend-color planned-route-color" }),
              _jsx("span", { children: "Planned route" }),
            ],
          }),
        ],
      }),
