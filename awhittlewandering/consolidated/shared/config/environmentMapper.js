...
const ENV_MAPPINGS = {
  ...
  TESSIE_TOKEN: ["VITE_TESSIE_TOKEN", "TESSIE_API_TOKEN", "TESLA_API_TOKEN"],

  // Vehicle identification
  VEHICLE_VIN: ["VITE_TESSIE_VIN", "TESLA_VIN", "VEHICLE_VIN"],
  ...
  // API configuration
  API_BASE_URL: ["VITE_API_BASE_URL", "API_ENDPOINT", "API_URL"],
