          ...
          <CardContent className="p-6">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 p-3 bg-popover border border-border rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
              ...
              <div className="text-xs space-y-1 text-muted-foreground">
                ...
                <p className="text-xs text-muted-foreground">Note: Actual Supercharger cost was $1,847</p>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-success">3.8 mi/kWh</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">Worst Day</span>
                        <span className="font-medium text-warning">1.6 mi/kWh</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-destructive/20 text-destructive border-0">-12%</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Elevation Changes</span>
                        <Badge className="bg-warning/20 text-warning border-0">-8%</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                ...
                <Card className="bg-secondary border-border">
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-success">$830</p>
                      <p className="text-xs text-success">If charged at home rates</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-primary/20 text-primary border-0">78%</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Destination</span>
                        <Badge className="bg-success/20 text-success border-0">15%</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Level 2</span>
                        <Badge className="bg-accent/20 text-accent border-0">7%</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
