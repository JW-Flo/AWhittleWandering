...
async function validateWebsite() {
  ...
  try {
    ...
    console.log(
      "🔍 Testing https://db0a3246.awhittlewandering-site.pages.dev..."
    );

    // Navigate to the website
    await page.goto("https://db0a3246.awhittlewandering-site.pages.dev", {
    ...
    if (rootContent.trim().length > 0) {
      ...
      const hasContent =
        (await page.$('main, .content, [class*="app"]')) !== null;
